    ...
    if (this.lang == 'GEO') {
      ...
      keys.forEach((element) => {
        if (element == 'იმერეთი_რაჭა_ლეჩხუმი_ქვემოსვანეთი') {
          regions.push({
            name: 'იმერეთი_რაჭა_ლეჩხუმი',
            value: RegionID[element],
            isDisabled: false,
          });
        } else {
          regions.push({
    ...
    if (this.lang == 'ENG') {
      ...
      keys.forEach((element) => {
        if (element == 'Imereti_Racha_Lechkhumi_Kvemosvaneti') {
          regions.push({
            name: 'Imereti_Racha_Lechkhumi',
            value: RegionIDEN[element],
            isDisabled: false,
          });
        } else {
          regions.push({
