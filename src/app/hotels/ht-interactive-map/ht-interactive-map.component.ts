...
export class HtInteractiveMapComponent implements OnInit {
  ...
  sortCountryes() {
    ...
    if (this.checkCountryes) {
      this.chartData.sort((a: any, b: any) => b.countryName.localeCompare(a.countryName));
    }
    else{
      this.chartData.sort((a: any, b: any) => a.countryName.localeCompare(b.countryName));
    }


    // if (this.checkCountryes) {
    //   let newar = this.chartData.sort((a: any, b: any) => {
  ...
  sortDataByVisits() {
    ...
    if (this.visits) {
      this.chartData = this.chartData.sort((a: any, b: any) => b.value - a.value);
    }
    else{
      this.chartData = this.chartData.sort((a: any, b: any) => a.value - b.value);
    }
  }
  ...
  mapChart(res: any[]){
    ...
    polygonTemplate.events.on("hit", (ev: { target: { series: { chart: { zoomToMapObject: (arg0: any) => void; }; }; dataItem: { dataContext: any; }; }; }) => {
    ...
    this.polygonSeries.heatRules.push({
      ...
      min: am4core.color('#5CB5FA'),
      max: am4core.color('#1200FA'),
