...
export class ComparisionService {
  ...
  Ages: string[] = ['15-30', '31-50', '51+'];

  GendersGE: string[] = ['ქალი', 'კაცი'];

  GendersEN: string[] = ['Male', 'Female'];
  ...
  SequencesGE: string[] = ['პირველი ვიზიტი', 'განმეორებითი ვიზიტი'];

  SequencesEN: string[] = ['First visit', 'Repeating visit'];
  ...
  TourTypesGE: string[] = ['ექსკურსანტი', 'ტურისიტი'];

  TourTypesEN: string[] = ['Same-day visit', 'Tourist visit'];
  ...
  ExpenditureGE: string[] = ['დანახარჯი'];

  ExpenditureEN: string[] = ['Expenditure'];
