...
@Component({
  selector: 'app-local-tourism',
  templateUrl: './local-tourism.component.html',
  styleUrls: ['./local-tourism.component.scss'],
})
export class LocalTourismComponent implements OnInit {
  [x: string]: any;
