...
@Component({
  selector: 'app-in-tourism',
  templateUrl: './in-tourism.component.html',
  styleUrls: ['./in-tourism.component.scss'],
})
export class InTourismComponent implements OnInit {
  [x: string]: any;
  ...
  selectCountryChange() {
    this.selectedCountry = this.countrySelect;
    this.getSeasonalQuery().subscribe((arg) => {
      this.createChart(arg);
      console.log(arg)
    });
  ...
  // getSeasonalQuery() {
  //   return this.http.get<any>(this.APIUrl + '/Visitor?tourType=' + this.tourType + '&gender=' + this.selectedGender + '&age=' + this.selectedAge + '&countryId=' + this.selectedCountry
  //   );
  // }

  getSeasonalQuery() {
    return this.http.get<any>(this.APIUrl + '/VisitorIn?tourType=' + this.tourType + '&gender=' + this.selectedGender + '&age=' + this.selectedAge + '&countryId=' + this.selectedCountry
    );
  }
